...
function displayPics(){
  ...
  // Because rando is a local variable definded in a scoop it can't be used out it ,that's why the consle.log(rando) didn't work because it was made in the global scoop
  console.log(viewed);
